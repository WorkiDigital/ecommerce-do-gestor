      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 max-w-4xl mx-auto">
          <div className="relative group">
            <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-700 to-indigo-700 rounded-[28px] blur-xl opacity-10 group-hover:opacity-15 transition" />
            <form
              onSubmit={handleSearch}
              className="relative bg-white dark:bg-slate-900 rounded-[24px] border-2 border-slate-200 dark:border-slate-800 shadow-xl shadow-slate-900/5 p-2"
            >
              <div className="flex flex-col sm:flex-row gap-2">
                <div className="flex-1 flex items-center gap-3 px-4 h-14">
                  ...
                  <input
                    ...
                    className="w-full bg-transparent outline-none text-base text-slate-900 dark:text-white placeholder-slate-500 font-medium"
                  />
                </div>
                <button
                  type="submit"
